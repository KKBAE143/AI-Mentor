...
function billing() {
  ...
  <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 sm:items-center md:gap-8">
    ...
    <div className="rounded-2xl bg-white border border-gray-200 p-6 shadow-sm sm:px-8 lg:p-12 h-full">
    ...
    <div className="rounded-2xl bg-white border border-gray-200 p-6 shadow-sm sm:px-8 lg:p-12 h-full">
      ...
      <Button
        ...
        className='w-full rounded-full mt-5 p-6 transition-transform transform hover:scale-105' // Added animation on hover
        variant='outline'
      >
